      ...
      <div class="row">
        ...
        <div class="posts col-9">
          <div class="button row">
            <a href="create.php" class="col-3 btn btn-success">Создать жанр</a>
            <span class="col-1"></span>
            <a href="index.php" class="col-3 btn btn-warning">Управление жанрами</a>
          </div>
          ...
          <div class="row post">
            ...
            <div class="title col-5">Пейзажи</div>
            <div class="image col-2">Картина</div>
          ...
          <div class="row post">
            <div class="id col-1">1</div>
            <div class="title col-5">Натюрморты</div>
            <div class="image col-2">Картина</div>
            <div class="red col-2"><a href="#">edit</a></div>
            <div class="del col-2"><a href="#">delete</a></div>
          </div>
          <div class="row post">
            <div class="id col-1">1</div>
            <div class="title col-5">Портреты</div>
            <div class="image col-2">Картина</div>
            <div class="red col-2"><a href="#">edit</a></div>
            <div class="del col-2"><a href="#">delete</a></div>
          </div>
